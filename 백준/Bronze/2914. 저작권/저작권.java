...
public class Main {
    public static void main(String[] args) {
        ...
        예를 들어, 창영이의 1집 앨범 "영창에서 영원히 영창피아노를 친다"에 총 38개 곡이 수록되어 있고, 이 앨가범에 저작권이 있는 멜로디 894개가 있다면,
        ...
        멜로디(x) / 곡 개수(A) = 평균값 (I) -> 항상 올림
        적어도 멜로디가 몇 개 여야 평균값이 나올까?
